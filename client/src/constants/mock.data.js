...
export const landingFeatures = [
  {
    ...
    description:
      "See every parking spot update live - no refreshing, no guessing. Green means go.",
    icon: Bell,
  },
  {
    title: "Reserve in seconds",
    description:
      "Pick your spot, choose the time interval, and confirm your reservation instantly.",
    icon: CalendarCheck,
  },
  {
    title: "Built for clients and admins",
    description:
      "Clients manage reservations and vehicles, while administrators monitor spots, hardware and reports.",
    icon: Users,
  },
];
...
export const recentActivities = [
  {
    type: "Reservation",
    title: "A-12 reserved by Andrei Pop",
    time: "2 min ago",
    status: "success",
  },
  {
    type: "Cancellation",
    title: "B-04 cancelled by Ioana D.",
    time: "10 min ago",
    status: "warning",
  },
  {
    type: "Entry",
    title: "Vehicle B-92-UNI entered via gate 1",
    time: "14 min ago",
    status: "info",
  },
  {
    type: "Conflict",
    title: "Spot C-07 occupied unexpectedly",
    time: "26 min ago",
    status: "danger",
  },
  {
    type: "No-show",
    title: "Reservation expired for D-11",
    time: "38 min ago",
    status: "warning",
  },
];
...
export const parkingSpots = [
  ...
  },
  {
    ...
    price: "4 RON/h",
    user: "Maria I.",
    remainingTime: "Starts in 15m",
    plate: "CJ-11-PKS",
    restrictions: "Reserved area",
  },
  {
    id: "B5",
    number: 5,
...
export const notifications = [
  {
    ...
    description: "Your spot A-12 starts in 15 minutes.",
  },
  {
    title: "Campus traffic alert",
    description: "Main entrance is busy between 10:00 and 11:00.",
  },
  {
    title: "Monthly summary",
    description: "You saved 5 minutes on average per booking this month.",
  },
];
...
export const devices = [
  {
    ...
    status: "Online",
    uptime: "99.8%",
    errors: ["No critical issues in last 7 days"],
  },
  {
    id: 2,
    name: "Level 1 Sensor Hub",
    type: "Sensor",
    status: "Needs calibration",
    uptime: "96.1%",
    errors: ["Calibration drift detected", "Signal latency peak on Apr 22"],
  },
  {
    id: 3,
    name: "Entry Camera",
    ...
    status: "Online",
    uptime: "98.9%",
    errors: ["Night OCR confidence dropped below threshold"],
  },
  {
    id: 4,
    name: "East Wing Sensor",
    type: "Sensor",
    status: "Offline",
    uptime: "81.5%",
    errors: ["Power interruption", "Packet loss from gateway"],
  },
];
...
export const reports = [
  {
    ...
    value: "Peak: 11:00 - 13:00",
    description: "Average occupancy is highest around lunch break.",
  },
  {
    title: "Average duration",
    value: "1h 42m",
    description: "Most bookings stay under two hours.",
  },
  {
    title: "Monthly revenue",
    value: "24,600 RON",
    description: "Revenue has grown steadily for three months.",
  },
  {
    title: "New vs returning",
    value: "38% / 62%",
    description: "Returning users remain the dominant segment.",
  },
  {
    title: "Issue reports",
    value: "12 this month",
    description: "Mostly cancellations and no-shows.",
  },
];
